...
public class FrogHex3 : MonoBehaviour
{
    ...
    private void Update()
    {
        if (menuOpen == 1 && Camera.main.fieldOfView <= 65f && !GameObject.Find("Grass Frog"))
        {
        ...
        if (!GameObject.Find("Background") && !GameObject.Find("Grass Frog") && Camera.main.fieldOfView <= 65f && menuOpen == 0)
        {
            if (prefabLimit != 1)
            {
