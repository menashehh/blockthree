...
public class FrogHex2 : MonoBehaviour
{
    ...
    private void Update()
    {
        if (menuOpen == 1 && Camera.main.fieldOfView <= 80f && !GameObject.Find("Tree Frog"))
        {
        ...
        if (!GameObject.Find("Background") && !GameObject.Find("Tree Frog") && Camera.main.fieldOfView <= 80f && menuOpen == 0)
        {
            if (prefabLimit != 1)
            {
