...
public class BuzzardHex2 : MonoBehaviour
{
    ...
    private void Update()
    {
        if (menuOpen == 1 && Camera.main.fieldOfView <= 65f && !GameObject.Find("Grass Buzzard"))
        {
        ...
        if (!GameObject.Find("Background") && !GameObject.Find("Grass Buzzard") && Camera.main.fieldOfView <= 65f && menuOpen == 0)
        {
            if (prefabLimit != 1)
            {
