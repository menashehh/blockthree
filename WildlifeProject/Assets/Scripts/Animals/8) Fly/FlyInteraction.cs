...
public class FlyInteraction : MonoBehaviour
{
    ...
    {
        if (Camera.main.fieldOfView == 80f && !GameObject.Find("Bee") && !GameObject.Find("Background") && !GameObject.Find("frogText") && !GameObject.Find("gooseText") && !GameObject.Find("wolfText") && !GameObject.Find("beaverText"))
        {
    ...
    {
        if (!GameObject.Find("Bee") && !GameObject.Find("Background") && GameObject.Find("flyText"))
        {
    ...
    {
        if (npcName == false && !GameObject.Find("Bee"))
        {
    ...
    private void OnGUI()
    {
        ...
        if (!GameObject.Find("Background"))
        {
            ...
            else if (Camera.main.fieldOfView == 80f && npcName == false && !GameObject.Find("Bee"))
            {
