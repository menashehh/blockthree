...
public class FlyHex : MonoBehaviour
{
    ...
    private void Update()
    {
        if (menuOpen == 1 && Camera.main.fieldOfView <= 65f && !GameObject.Find("Fly Req"))
        {
        ...
        if (!GameObject.Find("Background") && !GameObject.Find("Fly Req") && Camera.main.fieldOfView <= 65f && menuOpen == 0)
        {
            if (prefabLimit != 1)
            {
